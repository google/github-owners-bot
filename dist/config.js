...
nconf // 1. Command-line arguments
.argv() // 2. Environment variables
.env(['CLOUD_BUCKET', 'DATA_BACKEND', 'GCLOUD_PROJECT', 'NODE_ENV', 'OAUTH2_CLIENT_ID', 'OAUTH2_CLIENT_SECRET', 'OAUTH2_CALLBACK', 'PORT', 'SECRET', 'GITHUB_ACCESS_TOKEN', 'GITHUB_REPO_DIR', 'GITHUB_BOT_USERNAME']) // 3. Config file
.file({
